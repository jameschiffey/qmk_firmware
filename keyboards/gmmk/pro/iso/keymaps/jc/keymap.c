...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______, _______, RGB_VAI, _______, RGB_TOG, _______, _______, _______, _______, _______, RGB_MOD, _______, _______,                   _______,
        _______, _______, RGB_VAD, _______, _______, _______, RGB_HUI, _______, _______, RGB_SPD, RGB_RMOD, RGB_SPI, _______, _______,          _______,
        _______, RESET,   _______, _______, _______, _______, _______, NK_TOGG, _______, _______, _______, _______,          _______, KC_PGUP, _______,
